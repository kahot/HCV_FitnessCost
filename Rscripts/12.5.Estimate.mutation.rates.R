...
Mutrates$mutations<-factor(Mutrages$mutations, levels=paste0(Mutrages$mutations))                           
...
ggsave("Output1A/SummaryFig.Filtered/Mutation.rates.pdf", width = 6, height = 4)


mean(Mutrates$`In vivo estimation`, na.rm = T)-mean(Mutrates$`In vitro`)
...
ggsave("Output1A/SummaryFig.Filtered/Mutation.rates.correlation.pdf", width = 4.5, height = 4)
